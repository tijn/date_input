// This DateInput now has mousewheel support, it requires Brandon Aaron's jquery.mousewheel.js.
...
DateInput.prototype = {
  build: function() {
    var monthNav = $('<p class="month_nav">' +
      ...
      ' <span class="month_name" title="use the scroll wheel to quickly browse through months"></span> ' +
    ...
    this.monthNameSpan.mousewheel( this.bindToObj(function(event, delta) { this.moveMonthBy(-delta); return false }));

    var yearNav = $('<p class="year_nav">' +
      '<span class="button prev" title="[Ctrl+Page-Up]">&#171;</span>' +
      ' <span class="year_name" title="use the scroll wheel to quickly browse through years"></span> ' +
    ...
    this.yearNameSpan.mousewheel( this.bindToObj(function(event, delta) { this.moveMonthBy(-12*delta); return false }));
    ...
    this.dateSelector.mousewheel( this.bindToObj(function(event, delta) { this.moveMonthBy(-delta); return false }));
